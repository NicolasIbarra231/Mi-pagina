...
import Img5 from '../assets/RobotMovil.jpeg'
    ...
    <div className='container my-auto mx-auto'>
      <div className='flex flex-col lg:flex-row gap-x-10'>
        <motion.div 
          ...
          <div>
          <h2 className='h2 leading-tight text-purple-400'>
            My portfolio
          </h2>
          <p className='max-w-sm mb-16'>
          In this section you can find the most important works and projects in which I have collaborated and developed. They understand basic topics of the mechatronic engineering career.
          </p>
